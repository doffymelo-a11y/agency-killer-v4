...
-- 3. Cliquer "Run"
-- 4. Votre compte (doffymelo@gmail.com) sera automatiquement super_admin
--
-- ═══════════════════════════════════════════════════════════════
...
FROM auth.users u
LEFT JOIN user_roles ur ON u.id = ur.user_id
WHERE u.email = 'doffymelo@gmail.com';
...
-- ✅ Fonctions admin créées
-- ✅ Votre compte (doffymelo@gmail.com) est super_admin
-- ✅ Trigger auto-creation role sur signup
--
-- NEXT: Rechargez http://localhost:5173/projects
--       → Vous devriez voir le bouton rouge "Admin"
--
-- ═══════════════════════════════════════════════════════════════
